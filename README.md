...
※ ブラウザ翻訳では、一部の専門用語や技術表現が意図と異なる意味に変換される場合があります。正確な内容は日本語原文をご確認ください。
...
Nesting1Dは、定尺の新品材、在庫として保管している新品材、残材から、必要な長さの部材を切り出すための一次元ネスティングWebアプリです。丸棒、角材、パイプ、木材など、長さを基準に管理する材料を対象とします。

### 主な利用場面

* 切り出す部材の寸法や数量が多く、材料への割り付けを考えるのが難しい場合
* 在庫として保管している新品材や残材を含めて切断計画を作成したい場合
* 追加購入が必要な新品材の数量を事前に確認したい場合
* 材料見積りの補助として、必要な母材の数量を確認したい場合
* 現場で使用できる切断順序や切断パターンを確認したい場合

### 基本的な使い方

1. 必要な部材の寸法と数量を入力します。
2. 新品の母材長、鋸刃厚、左端の捨て切り寸法を入力します。
3. 在庫を使用する場合は、在庫として保管している新品材と残材を入力します。
4. 計算を実行し、切断計画と現場向けの切断手順を確認します。

件名、材料種類、データ製作者、備考などの任意情報も入力できます。入力項目と制約の詳細は[仕様書](docs/REQUIREMENTS.md)を参照してください。
